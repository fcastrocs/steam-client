...
class Steam extends connection_1.default {
    ...
    createMachineID(accountName) {
        ...
        const hash = steam_crypto_ts_1.default.sha1(accountName);
    ...
    clientUpdateMachineAuthResponse(sentry) {
        const stringHex = steam_crypto_ts_1.default.sha1(sentry);
