...
export default class Auth extends EventEmitter {
  ...
  public async getAuthTokensViaCredentials(
    ...
    const res: CAuthentication_BeginAuthSessionViaCredentials_Response = await this.steam.conn.sendServiceMethodCall(
      this.serviceName,
  ...
  private pollAuthStatusInterval() {
    ...
    const intervalId = setInterval(async () => {
      const pollStatus: CAuthentication_PollAuthSessionStatus_Response = await this.steam.conn.sendServiceMethodCall(
        this.serviceName,
