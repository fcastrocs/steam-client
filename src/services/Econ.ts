...
import type { CEcon_GetInventoryItemsWithDescriptions_Response, CEcon_GetInventoryItemsWithDescriptions_Request } from "../../@types/protos/steammessages_econ.steamclient.js";
...
export default class Econ {
    ...
    async getInventoryItems(appid: number, contextid: number, tradableOnly?: boolean) {
        const res: CEcon_GetInventoryItemsWithDescriptions_Response = await this.steam.conn.sendServiceMethodCall(this.serviceName, "GetInventoryItemsWithDescriptions", {
