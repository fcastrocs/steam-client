...
export const EPurchaseResultDetail = {
	NoDetail: 0,
	AVSFailure: 1,
	InsufficientFunds: 2,
	ContactSupport: 3,
...
export const EIntroducerRouting = {
	P2PVoiceChat: 1,
	P2PNetworking: 2,
};

export const EServerFlags = {
	None: 0,
	Active: 1,
	Secure: 2,
	Dedicated: 4,
...
export const EClanRelationship = {
	None: 0,
	Blocked: 1,
	Invited: 2,
	Member: 3,
...
export const EChatRoomType = {
	Friend: 1,
	MUC: 2,
	Lobby: 3,
};

export const EChatInfoType = {
	StateChange: 1,
	InfoUpdate: 2,
	MemberLimitChange: 3,
};

export const EChatAction = {
	InviteChat: 1,
	Kick: 2,
	Ban: 3,
	UnBan: 4,
...
export const EChatActionResult = {
	Success: 1,
	Error: 2,
	NotPermitted: 3,
...
export const EContentDownloadSourceType = {
	Invalid: 0,
	CS: 1,
	CDN: 2,
	LCS: 3,
...
export const EActivationCodeClass = {
	WonCDKey: 0,
	ValveCDKey: 1,
	Doom3CDKey: 2,
	DBLookup: 3,
...
export const EPublishedFileVisibility = {
	Public: 0,
	FriendsOnly: 1,
	Private: 2,
};
...
export const EMarketingMessageFlags = {
	None: 0,
	HighPriority: 1,
	PlatformWindows: 2,
	PlatformMac: 4,
...
export const EDRMBlobDownloadErrorDetail = {
	None: 0,
	DownloadFailed: 1,
	TargetLocked: 2,
	OpenZip: 3,
...
export const EClientStatAggregateMethod = {
	LatestOnly: 0,
	Sum: 1,
	Event: 2,
	Scalar: 3,
...
export const EChatRoomGroupType = {
	Default: 0,
	Unmoderated: 1,
};
...
export const EChatRoomServerMsg = {
	Invalid: 0,
	RenameChatRoom: 1,
	Joined: 2,
	Parted: 3,
...
export const EChatRoomGroupPermissions = {
	Default: 0,
	Valid: 1,
	CanInvite: 2,
	CanKick: 4,
...
export const EChatRoomGroupAction = {
	Default: 0,
