...
export declare enum EAuthSessionGuardType {
    Unknown = 0,
    None = 1,
    EmailCode = 2,
    DeviceCode = 3,
...
export declare enum EAuthSessionSecurityHistory {
    Invalid = 0,
    UsedPreviously = 1,
    NoPriorHistory = 2
}
export declare enum ETokenRenewalType {
    None = 0,
    Allow = 1
}
export declare enum EAuthTokenRevokeAction {
...
export declare enum EAuthTokenState {
    Invalid = 0,
    New = 1,
    Confirmed = 2,
    Issued = 3,
