...
export declare enum EMsg {
    ...
    EconBase = 7700,
    InitiateTradeRequest = 7701,
    InitiateTradeProposed = 7702,
    InitiateTradeResponse = 7703,
    InitiateTradeResult = 7704,
    StartSession = 7705,
    CancelTradeRequest = 7706,
...
export declare enum EClientPersonaStateFlag {
    Status = 1,
    PlayerName = 2,
    QueryPort = 4,
    SourceID = 8,
...
export declare enum EMsgClanAccountFlags {
...
export declare enum ESteamReviewScore {
...
export declare enum ECodecUsagePlatform {
    Unknown = 0,
    Windows = 1,
    MacOS = 2,
    Linux = 3,
...
export declare enum ECodecUsageReason {
    Unknown = 0,
    RemotePlay = 1,
    Broadcasting = 2,
    GameVideo = 3
