...
export declare enum EChatEntryType {
    Invalid = 0,
    ChatMsg = 1,
    Typing = 2,
    InviteGame = 3,
...
export declare enum EAccountFlags {
    NormalUser = 0,
    PersonaNameSet = 1,
    Unbannable = 2,
    PasswordSet = 4,
...
export declare enum EClanPermission {
    Nobody = 0,
    Owner = 1,
    Officer = 2,
    OwnerAndOfficer = 3,
...
export declare enum EChatPermission {
    Close = 1,
    Invite = 2,
    Talk = 8,
    Kick = 16,
...
export declare enum EAppUsageEvent {
    GameLaunch = 1,
    GameLaunchTrial = 2,
    Media = 3,
    PreloadStart = 4,
...
export declare enum ELicenseFlags {
    None = 0
}
export declare enum ELicenseType {
    NoLicense = 0,
    SinglePurchase = 1,
...
export declare enum EPurchaseResultDetail {
    NoDetail = 0,
    AVSFailure = 1,
    InsufficientFunds = 2,
    ContactSupport = 3,
...
export declare enum EIntroducerRouting {
    P2PVoiceChat = 1,
    P2PNetworking = 2
}
export declare enum EServerFlags {
    None = 0,
    Active = 1,
    Secure = 2,
    Dedicated = 4,
...
export declare enum EDenyReason {
    InvalidVersion = 1,
    Generic = 2,
    NotLoggedOn = 3,
    NoLicense = 4,
...
export declare enum EClanRelationship {
    None = 0,
    Blocked = 1,
    Invited = 2,
    Member = 3,
...
export declare enum EAuthSessionResponse {
    OK = 0,
...
export declare enum EChatRoomEnterResponse {
    Success = 1,
    DoesntExist = 2,
    NotAllowed = 3,
    Full = 4,
...
export declare enum EChatRoomType {
    Friend = 1,
    MUC = 2,
    Lobby = 3
}
export declare enum EChatInfoType {
    StateChange = 1,
    InfoUpdate = 2,
    MemberLimitChange = 3
}
export declare enum EChatAction {
    InviteChat = 1,
    Kick = 2,
    Ban = 3,
    UnBan = 4,
...
export declare enum EChatActionResult {
    Success = 1,
    Error = 2,
    NotPermitted = 3,
...
export declare enum EAppInfoSection {
    Unknown = 0,
    All = 1,
    First = 2,
    Common = 2,
...
export declare enum EContentDownloadSourceType {
    Invalid = 0,
    CS = 1,
    CDN = 2,
    LCS = 3,
...
export declare enum EPlatformType {
    Unknown = 0,
    Win32 = 1,
    Win64 = 2,
    Linux64 = 3,
...
export declare enum EBillingType {
    NoCost = 0,
    BillOnceOnly = 1,
    BillMonthly = 2,
...
export declare enum EPackageStatus {
    Available = 0,
    Preorder = 1,
    Unavailable = 2,
    Invalid = 3
}
export declare enum EActivationCodeClass {
    WonCDKey = 0,
    ValveCDKey = 1,
    Doom3CDKey = 2,
    DBLookup = 3,
...
export declare enum EChatMemberStateChange {
}
export declare enum ERegionCode {
}
export declare enum ECurrencyCode {
    Invalid = 0,
    USD = 1,
    GBP = 2,
    EUR = 3,
...
export declare enum EDepotFileFlag {
    UserConfig = 1,
...
export declare enum EWorkshopEnumerationType {
    RankedByVote = 0,
    Recent = 1,
    Trending = 2,
    FavoriteOfFriends = 3,
...
export declare enum EPublishedFileVisibility {
    Public = 0,
    FriendsOnly = 1,
    Private = 2
}
...
export declare enum EWorkshopFileAction {
    Played = 0,
    Completed = 1
}
export declare enum EEconTradeResponse {
    Accepted = 0,
    Declined = 1,
...
export declare enum EMarketingMessageFlags {
    None = 0,
    HighPriority = 1,
    PlatformWindows = 2,
    PlatformMac = 4,
...
export declare enum ENewsUpdateType {
    AppNews = 0,
    SteamAds = 1,
    SteamNews = 2,
    CDDBUpdate = 3,
...
export declare enum ESystemIMType {
    RawText = 0,
    InvalidCard = 1,
...
export declare enum EChatFlags {
    Locked = 1,
    InvisibleToFriends = 2,
    Moderated = 4,
    Unjoinable = 8
}
export declare enum ERemoteStoragePlatform {
    None = 0,
    Windows = 1,
    OSX = 2,
    PS3 = 4,
...
export declare enum EDRMBlobDownloadType {
    Error = 0,
    File = 1,
    Parts = 2,
    Compressed = 4,
...
export declare enum EDRMBlobDownloadErrorDetail {
    None = 0,
    DownloadFailed = 1,
    TargetLocked = 2,
    OpenZip = 3,
...
export declare enum EClientStat {
    P2PConnectionsUDP = 0,
...
export declare enum EClientStatAggregateMethod {
    LatestOnly = 0,
    Sum = 1,
    Event = 2,
    Scalar = 3
}
export declare enum ELeaderboardDataRequest {
    Global = 0,
    GlobalAroundUser = 1,
    Friends = 2,
    Users = 3
}
export declare enum ELeaderboardSortMethod {
    None = 0,
    Ascending = 1,
    Descending = 2
}
export declare enum ELeaderboardDisplayType {
    None = 0,
    Numeric = 1,
    TimeSeconds = 2,
    TimeMilliSeconds = 3
}
export declare enum ELeaderboardUploadScoreMethod {
    None = 0,
    KeepBest = 1,
    ForceUpdate = 2
}
...
export declare enum EChatRoomGroupType {
    Default = 0,
    Unmoderated = 1
}
export declare enum EChatroomNotificationLevel {
    Invalid = 0,
    None = 1,
    MentionMe = 2,
    MentionAll = 3,
...
export declare enum EChatRoomMemberStateChange {
    Invalid = 0,
    Joined = 1,
    Parted = 2,
    Kicked = 3,
...
export declare enum EChatRoomServerMsg {
    Invalid = 0,
    RenameChatRoom = 1,
    Joined = 2,
    Parted = 3,
...
export declare enum EChatRoomGroupRank {
    Default = 0,
    Viewer = 10,
    Guest = 15,
    Member = 20,
...
export declare enum EChatRoomGroupPermissions {
    Default = 0,
    Valid = 1,
    CanInvite = 2,
    CanKick = 4,
...
export declare enum EChatRoomGroupAction {
    Default = 0,
...
export declare enum EChatRoomJoinState {
    Default = 0,
    None = 1,
    Joined = 2
}
export declare enum EVoiceCallState {
    None = 0,
    ScheduledInitiate = 1,
...
export declare enum ETradeOfferState {
    Invalid = 1,
    Active = 2,
    Accepted = 3,
    Countered = 4,
...
export declare enum ETradeOfferConfirmationMethod {
    Invalid = 0,
    Email = 1,
    MobileApp = 2
}
export declare enum ELobbyType {
    Private = 0,
    FriendsOnly = 1,
    Public = 2,
    Invisible = 3,
...
export declare enum ELobbyFilterType {
    String = 0,
    Numerical = 1,
    SlotsAvailable = 2,
    NearValue = 3,
...
export declare enum ELobbyComparison {
    Equal = 0,
    GreaterThan = 1,
    EqualToOrGreaterThan = 2,
    NotEqual = 3
}
export declare enum ELobbyDistanceFilter {
    Close = 0,
    Default = 1,
    Far = 2,
    Worldwide = 3
}
export declare enum ESteamIPv6ConnectivityProtocol {
    Invalid = 0,
    Http = 1,
    Udp = 2
}
export declare enum ESteamIPv6ConnectivityState {
    Unknown = 0,
    Good = 1,
    Bad = 2
}
...
export declare enum ELauncherType {
    Default = 0,
    PerfectWorld = 1,
    Nexon = 2,
    CmdLine = 3,
